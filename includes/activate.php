...
if (!class_exists('WOO_OTP_ACTIVATE')) {
    class WOO_OTP_ACTIVATE
    {
        public function __construct()
        {
            ...
            $woo_otp_setting_twilio =
                'CREATE TABLE IF NOT EXISTS `' .
                WOO_OTP_DB_SETTING_TWILIO.
                "` (
                `id` int(11) NOT NULL AUTO_INCREMENT,  
                `otp_resend_timer_twilio` varchar(255) NOT NULL,    
                `otp_length` varchar(255) NOT NULL,       
                `otp_expire_time` varchar(255) NOT NULL,                   
                `country_code` varchar(255) NOT NULL,              
                ...
                `otp_message` varchar(255) NOT NULL,        
                `twilio_reg_no` varchar(255) NOT NULL,                                                       
                PRIMARY KEY (id)        
            ) $charset_collate;";
            dbDelta($woo_otp_setting_twilio);
        }
    }
}
